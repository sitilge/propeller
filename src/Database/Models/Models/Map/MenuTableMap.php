...
use Models\Models\Menu;
use Models\Models\MenuQuery;
...
class MenuTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Models.Models.Map.MenuTableMap';
     ...
     */
    const OM_CLASS = '\\Models\\Models\\Menu';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Models.Models.Menu';
     ...
     */
    const COL_SLUG = 'menu.slug';

    /**
     * the column name for the display field
     */
    const COL_DISPLAY = 'menu.display';

    /**
     * the column name for the sequence field
     */
    const COL_SEQUENCE = 'menu.sequence';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Slug', 'Display', 'Sequence', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'slug', 'display', 'sequence', ),
        self::TYPE_COLNAME       => array(MenuTableMap::COL_ID, MenuTableMap::COL_NAME, MenuTableMap::COL_SLUG, MenuTableMap::COL_DISPLAY, MenuTableMap::COL_SEQUENCE, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'slug', 'display', 'sequence', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Slug' => 2, 'Display' => 3, 'Sequence' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'slug' => 2, 'display' => 3, 'sequence' => 4, ),
        self::TYPE_COLNAME       => array(MenuTableMap::COL_ID => 0, MenuTableMap::COL_NAME => 1, MenuTableMap::COL_SLUG => 2, MenuTableMap::COL_DISPLAY => 3, MenuTableMap::COL_SEQUENCE => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'slug' => 2, 'display' => 3, 'sequence' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Models\\Models\\Menu');
        ...
        $this->addColumn('display', 'Display', 'INTEGER', true, null, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MenuTableMap::COL_SLUG);
            $criteria->addSelectColumn(MenuTableMap::COL_DISPLAY);
            $criteria->addSelectColumn(MenuTableMap::COL_SEQUENCE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Models\Models\Menu) { // it's a model object
