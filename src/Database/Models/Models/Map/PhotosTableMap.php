...
use Models\Models\Photos;
use Models\Models\PhotosQuery;
...
class PhotosTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Models.Models.Map.PhotosTableMap';
     ...
     */
    const OM_CLASS = '\\Models\\Models\\Photos';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Models.Models.Photos';
     ...
     */
    const COL_NAME = 'photos.name';

    /**
     * the column name for the color field
     */
    const COL_COLOR = 'photos.color';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Color', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'color', ),
        self::TYPE_COLNAME       => array(PhotosTableMap::COL_ID, PhotosTableMap::COL_NAME, PhotosTableMap::COL_COLOR, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'color', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Color' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'color' => 2, ),
        self::TYPE_COLNAME       => array(PhotosTableMap::COL_ID => 0, PhotosTableMap::COL_NAME => 1, PhotosTableMap::COL_COLOR => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'color' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Models\\Models\\Photos');
    ...
    {
        $this->addRelation('Users', '\\Models\\Models\\Users', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':photo',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PhotosTableMap::COL_NAME);
            $criteria->addSelectColumn(PhotosTableMap::COL_COLOR);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Models\Models\Photos) { // it's a model object
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(PhotosTableMap::COL_ID) && $criteria->keyContainsValue(PhotosTableMap::COL_ID) ) {
