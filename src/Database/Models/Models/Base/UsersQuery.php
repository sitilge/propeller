 ...
 * @method     ChildUsersQuery orderByPhoto($order = Criteria::ASC) Order by the photo column
 ...
 * @method     ChildUsersQuery groupByPhoto() Group by the photo column
 ...
 *
 * @method     \Models\Models\PhotosQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildUsers findOneByPhoto(int $photo) Return the first ChildUsers filtered by the photo column
 ...
 * @method     ChildUsers requireOneByPhoto(int $photo) Return the first ChildUsers filtered by the photo column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildUsers[]|ObjectCollection findByPhoto(int $photo) Return ChildUsers objects filtered by the photo column
...
abstract class UsersQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Models\Models\Base\UsersQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Models\\Models\\Users', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, surname, photo, email, birthday FROM users WHERE id = :p0';
        try {
    ...
    public function filterByPhoto($photo = null, $comparison = null)
    {
        if (is_array($photo)) {
            $useMinMax = false;
            if (isset($photo['min'])) {
                $this->addUsingAlias(UsersTableMap::COL_PHOTO, $photo['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($photo['max'])) {
                $this->addUsingAlias(UsersTableMap::COL_PHOTO, $photo['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UsersTableMap::COL_PHOTO, $photo, $comparison);
    }
    ...
    /**
     * Filter the query by a related \Models\Models\Photos object
     *
     * @param \Models\Models\Photos|ObjectCollection $photos The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($photos instanceof \Models\Models\Photos) {
            return $this
                ->addUsingAlias(UsersTableMap::COL_PHOTO, $photos->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(UsersTableMap::COL_PHOTO, $photos->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByPhotos() only accepts arguments of type \Models\Models\Photos or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Models\Models\PhotosQuery A secondary query class using the current class as primary query
     */
    public function usePhotosQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPhotos($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Photos', '\Models\Models\PhotosQuery');
    }
