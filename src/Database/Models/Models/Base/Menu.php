...
abstract class Menu implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Models\\Models\\Map\\MenuTableMap';
    ...
    /**
     * Initializes internal state of Models\Models\Base\Menu object.
     */
     ...
     * @return $this|\Models\Models\Menu The current object (for fluent API support)
     */
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[MenuTableMap::COL_SLUG] = true;
        }
    ...
    public function setDisplay($v)
    {
        ...
        if ($this->display !== $v) {
            $this->display = $v;
            $this->modifiedColumns[MenuTableMap::COL_DISPLAY] = true;
        }
    ...
    public function setSequence($v)
    {
        ...
        if ($this->sequence !== $v) {
            $this->sequence = $v;
            $this->modifiedColumns[MenuTableMap::COL_SEQUENCE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MenuTableMap::translateFieldName('Slug', TableMap::TYPE_PHPNAME, $indexType)];
            $this->slug = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MenuTableMap::translateFieldName('Display', TableMap::TYPE_PHPNAME, $indexType)];
            $this->display = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : MenuTableMap::translateFieldName('Sequence', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Models\\Models\\Menu'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MenuTableMap::COL_SLUG)) {
            $modifiedColumns[':p' . $index++]  = 'slug';
        }
        if ($this->isColumnModified(MenuTableMap::COL_DISPLAY)) {
            $modifiedColumns[':p' . $index++]  = 'display';
        }
        if ($this->isColumnModified(MenuTableMap::COL_SEQUENCE)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Models\Models\Menu
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Models\Models\Menu The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MenuTableMap::COL_SLUG)) {
            $criteria->add(MenuTableMap::COL_SLUG, $this->slug);
        }
        if ($this->isColumnModified(MenuTableMap::COL_DISPLAY)) {
            $criteria->add(MenuTableMap::COL_DISPLAY, $this->display);
        }
        if ($this->isColumnModified(MenuTableMap::COL_SEQUENCE)) {
            $criteria->add(MenuTableMap::COL_SEQUENCE, $this->sequence);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Models\Models\Menu (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Models\Models\Menu Clone of current object.
     * @throws PropelException
     */
