...
use Models\Models\UsersQuery as ChildUsersQuery;
use Models\Models\Map\UsersTableMap;
...
abstract class Users implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Models\\Models\\Map\\UsersTableMap';
    ...
    /**
     * Initializes internal state of Models\Models\Base\Users object.
     */
     ...
     * @return $this|\Models\Models\Users The current object (for fluent API support)
     */
    ...
    public function setPhoto($v)
    {
        ...
        if ($this->photo !== $v) {
            $this->photo = $v;
            $this->modifiedColumns[UsersTableMap::COL_PHOTO] = true;
        }

        if ($this->aPhotos !== null && $this->aPhotos->getId() !== $v) {
            $this->aPhotos = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UsersTableMap::translateFieldName('Photo', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UsersTableMap::translateFieldName('Birthday', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Models\\Models\\Users'), 0, $e);
        }
    }
    ...
    {
        if ($this->aPhotos !== null && $this->photo !== $this->aPhotos->getId()) {
            $this->aPhotos = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aPhotos !== null) {
                if ($this->aPhotos->isModified() || $this->aPhotos->isNew()) {
                    $affectedRows += $this->aPhotos->save($con);
                }
                $this->setPhotos($this->aPhotos);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_PHOTO)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aPhotos) {
                ...
                $result[$key] = $this->aPhotos->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Models\Models\Users
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Models\Models\Users The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_PHOTO)) {
            $criteria->add(UsersTableMap::COL_PHOTO, $this->photo);
        }
        if ($this->isColumnModified(UsersTableMap::COL_EMAIL)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Models\Models\Users (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Models\Models\Users Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildPhotos object.
     *
     * @param  ChildPhotos $v
     * @return $this|\Models\Models\Users The current object (for fluent API support)
     * @throws PropelException
     */
    public function setPhotos(ChildPhotos $v = null)
    {
        if ($v === null) {
            $this->setPhoto(NULL);
        } else {
            $this->setPhoto($v->getId());
        }

        $this->aPhotos = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildPhotos object, it will not be re-added.
        if ($v !== null) {
            $v->addUsers($this);
        }
    ...
    /**
     * Get the associated ChildPhotos object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildPhotos The associated ChildPhotos object.
     * @throws PropelException
     */
    public function getPhotos(ConnectionInterface $con = null)
    {
        if ($this->aPhotos === null && ($this->photo !== null)) {
            $this->aPhotos = ChildPhotosQuery::create()->findPk($this->photo, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPhotos->addUserss($this);
             */
        }
