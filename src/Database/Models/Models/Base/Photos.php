...
use Models\Models\Users as ChildUsers;
...
abstract class Photos implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Models\\Models\\Map\\PhotosTableMap';
    ...
    /**
     * Initializes internal state of Models\Models\Base\Photos object.
     */
     ...
     * @return $this|\Models\Models\Photos The current object (for fluent API support)
     */
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[PhotosTableMap::COL_NAME] = true;
        }
    ...
    public function setColor($v)
    {
        ...
        if ($this->color !== $v) {
            $this->color = $v;
            $this->modifiedColumns[PhotosTableMap::COL_COLOR] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PhotosTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PhotosTableMap::translateFieldName('Color', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = PhotosTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Models\\Models\\Photos'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->userssScheduledForDeletion !== null) {
                if (!$this->userssScheduledForDeletion->isEmpty()) {
                    \Models\Models\UsersQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[PhotosTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . PhotosTableMap::COL_ID . ')');
        }
        ...
        if ($this->isColumnModified(PhotosTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(PhotosTableMap::COL_COLOR)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Models\Models\Photos
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Models\Models\Photos The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PhotosTableMap::COL_NAME)) {
            $criteria->add(PhotosTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(PhotosTableMap::COL_COLOR)) {
            $criteria->add(PhotosTableMap::COL_COLOR, $this->color);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Models\Models\Photos (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Models\Models\Photos Clone of current object.
     * @throws PropelException
     */
    ...
    public function initUserss($overrideExisting = true)
    {
        ...
        $this->collUserss->setModel('\Models\Models\Users');
    }
     ...
     * If this ChildPhotos is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildPhotos The current object (for fluent API support)
     */
